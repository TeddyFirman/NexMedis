                ...
                @forelse ($posts as $post)
                    <div class="w-full md:w-1/3 px-4 mb-6">
                        <div class="bg-white shadow-md rounded-lg overflow-hidden">
                            ...
                            <!-- Modal toggle -->
                            <button data-modal-target="static-modal-{{ $post->id }}"
                                data-modal-toggle="static-modal-{{ $post->id }}"
                            ...
                            <!-- Main modal -->
                            <div id="static-modal-{{ $post->id }}" data-modal-backdrop="static" tabindex="-1"
                                aria-hidden="true"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div
                                            ...
                                            <button type="button"
                                                ...
                                                data-modal-hide="static-modal-{{ $post->id }}">
                                        ...
                                        <!-- Modal body -->
                                        <div class="p-4">
                                            <form action="{{ url('edit-postingan/' . $post->id) }}" method="POST"
                                                ...
                                                <div class="flex w-full flex-row space-x-4">
                                                    ...
                                                    <div class="w-1/2">
                                                        ...
                                                        <x-text-input class="my-2 block w-full" id="judulPost"
                                                            ...
                                                            value="{{ $post->judulPost }}" readonly autofocus />
                                                        @error('judulPost')
                                                ...
                                                <div class="flex w-full flex-row space-x-4">
                                                    <div class="flex w-1/2 flex-col">
                                                        ...
                                                        <textarea id="postingan" name="postingan"
                                                            class="my-2 min-h-36 w-full resize-none overflow-auto rounded border-2 border-gray-200 font-body text-primary-800 focus:border-secondary-400 focus:bg-gray-100 focus:shadow focus:ring-transparent" readonly>{{ $post->postingan }}</textarea>
                                                        @error('postingan')
                                                ...
                                                <div class="flex w-1/2 flex-col">
                                                    <x-input-label for="isi_komen" :value="__('Komentari')" />
                                                    <textarea id="isi_komen" name="isi_komen"
                                                ...
                                                <div class="flex justify-end pt-2">
                                                    <button type="submit"
                                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Komentari</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
